...
class Settings(BaseSettings):
    app_name: str = "ScopeForge Runtime Service"
    app_version: str = "0.1.0"
    environment: str = "local"
    enable_docs: bool = True

    runtime_workspace_root: str = "/var/lib/scopeforge-runtime"
    runtime_default_image: str = "scopeforge-runtime-python:local"
    runtime_container_label_prefix: str = "scopeforge"
