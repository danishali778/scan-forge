...
interface NewAssessmentHeaderProps {
  userInitials: string;
  workspaceName: string;
}

export function NewAssessmentHeader({ userInitials, workspaceName }: NewAssessmentHeaderProps) {
  return (
    <header className="flex h-[64px] shrink-0 items-center justify-between border-b border-slate-200 bg-white px-7">
      ...
      <div className="flex items-center gap-5">
        ...
        <button className="relative grid h-10 w-10 place-items-center rounded-full bg-slate-100 text-[12px] font-bold text-slate-700">
